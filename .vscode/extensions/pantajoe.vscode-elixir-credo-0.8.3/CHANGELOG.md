...
- Fixed Windows Support (#18, [#19](https://github.com/pantajoe/vscode-elixir-credo/issues/19))
...
- Added a configuration option `ignoreWarningMessages` in order to be able to ignore the following warning messages (especially if they come repeatedly, see [#4](https://github.com/pantajoe/vscode-elixir-credo/issues/4)):
