...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!config.get('rust.ignore_deprecation_warning', false)) {
            vscode_1.window
                .showWarningMessage('rust-lang.rust has been deprecated. Please uninstall this extension and install rust-lang.rust-analyzer instead. You can find the extension by clicking on one of the buttons', 'Open in your browser', 'Open in a new editor tab', 'Disable Warning')
                .then(button => {
                switch (button) {
                    case 'Disable Warning':
                        config.update('rust.ignore_deprecation_warning', true, vscode_1.ConfigurationTarget.Global);
                        break;
                    case 'Open in your browser':
                        vscode_1.commands.executeCommand('vscode.open', vscode_1.Uri.parse('https://marketplace.visualstudio.com/items?itemName=rust-lang.rust-analyzer'));
                        break;
                    case 'Open in a new editor tab':
                        vscode_1.commands.executeCommand('vscode.open', vscode_1.Uri.parse('vscode:extension/rust-lang.rust-analyzer'));
                        break;
                    default:
                }
            });
