...
describe('Environment credentials provider', () => {
    it('Check credentials name resolution', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        chai_1.expect('DRIVE_CREDENTIALS').to.equal(provider.resolveEnvName(credentialsManager_1.CREDENTIALS_JSON_SERVICE));
        chai_1.expect('DRIVE_TOKEN').to.equal(provider.resolveEnvName(credentialsManager_1.TOKENS_JSON_SERVICE));
        chai_1.expect('invalid').to.equal(provider.resolveEnvName('invalid-service'));
    }));
});
