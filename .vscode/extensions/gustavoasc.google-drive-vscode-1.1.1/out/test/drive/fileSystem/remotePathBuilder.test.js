...
describe('Remote path manipulation', () => {
    it('Checks remote path building', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        chai_1.expect('googledrive:///VSCode/subFolder/thirdFolder/myFile.txt#1Cdffsdfsdfsdfdfocz').to.equal(pathBuilder.buildRemotePathFromId(model, '1Cdffsdfsdfsdfdfocz'));
        chai_1.expect(undefined).to.equal(pathBuilder.buildRemotePathFromId(model, 'xxxxxx'));
    }));
});
