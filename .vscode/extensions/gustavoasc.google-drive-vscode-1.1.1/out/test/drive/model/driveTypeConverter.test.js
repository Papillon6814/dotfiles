...
describe('Drive type conversions from Google Drive API', () => {
    it('Empty result', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        chai_1.expect(0).to.equal(converted.length);
    }));
    it('Directory missing date', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const converted = new driveTypeConverter_1.DriveTypeConverter().fromApiToTypescript(apiFolders);
        chai_1.expect(1).to.equal(converted.length);
        chai_1.expect('ajsbo1j218fmxxnmaiouasion').to.equal(converted[0].id);
        chai_1.expect('foo').to.equal(converted[0].name);
        chai_1.expect('https://drive-thirdparty.googleusercontent.com/16/type/application/vnd.google-apps.folder').to.equal(converted[0].iconLink);
        chai_1.expect(driveTypes_1.FileType.DIRECTORY).to.equal(converted[0].type);
        chai_1.expect(undefined).to.equal(converted[0].parent);
        chai_1.expect(0).to.equal(converted[0].size);
        chai_1.expect(0).to.equal(converted[0].createdTime);
        chai_1.expect(0).to.equal(converted[0].modifiedTime);
    }));
    it('Contains only folders', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const converted = new driveTypeConverter_1.DriveTypeConverter().fromApiToTypescript(apiFolders);
        chai_1.expect(2).to.equal(converted.length);
        ...
        chai_1.expect(undefined).to.equal(converted[0].parent);
        chai_1.expect(0).to.equal(converted[0].size);
        chai_1.expect(1594941820311).to.equal(converted[0].createdTime);
        chai_1.expect(1595285078263).to.equal(converted[0].modifiedTime);
        // Check second file information
        chai_1.expect('sdasg32453255gnmaiouasion').to.equal(converted[1].id);
        chai_1.expect('bar').to.equal(converted[1].name);
        chai_1.expect('https://drive-thirdparty.googleusercontent.com/16/type/application/vnd.google-apps.folder').to.equal(converted[1].iconLink);
        chai_1.expect(driveTypes_1.FileType.DIRECTORY).to.equal(converted[1].type);
        chai_1.expect(undefined).to.equal(converted[1].parent);
        chai_1.expect(0).to.equal(converted[1].size);
        chai_1.expect(1560727420311).to.equal(converted[1].createdTime);
        chai_1.expect(1595288678263).to.equal(converted[1].modifiedTime);
    }));
    it('Contains one folder and one file', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // Check second file information
        chai_1.expect('sdasg32453255gnmaiouasion').to.equal(converted[1].id);
        chai_1.expect('bar.txt').to.equal(converted[1].name);
        chai_1.expect('https://drive-thirdparty.googleusercontent.com/16/type/text/plain').to.equal(converted[1].iconLink);
        chai_1.expect(driveTypes_1.FileType.FILE).to.equal(converted[1].type);
        chai_1.expect(undefined).to.equal(converted[1].parent);
        chai_1.expect(1071).to.equal(converted[1].size);
        chai_1.expect(1560727420311).to.equal(converted[1].createdTime);
        chai_1.expect(1595288678263).to.equal(converted[1].modifiedTime);
    }));
});
